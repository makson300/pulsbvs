...
export function Landing({ setView, setModal, loadDemo }: LandingProps) {
  const landingStats = [
    ['2 контура', 'анализ файлов и отдельный журнал полётов'],
    ...
    <main className="landing">
      ...
      <section className="hero">
        <div>
          ...
          <p>Пульс БВС помогает операторам и агроподрядчикам навести порядок: связать файлы полётов с нужным дроном и батареей, вести паспорта, задачи и отдельный цифровой журнал вылетов с чек-листами.</p>
        ...
        <aside className="hero-card">
          ...
          <div className="signal-list">
            ...
            <span><b>Цифровой журнал</b><em>ручная запись вылета и чек-листы ведутся отдельно от файлов</em></span>
          </div>
      ...
      <section className="landing-grid">
        <LandingCard kicker="01" title="Навести порядок" items={['Список дронов, батарей и их паспортов', 'История загрузок связана с нужным дроном и батареей', 'Понятно, какой файл дал какие выводы']} />
        <LandingCard kicker="02" title="Вести работу перед и после вылета" items={['Отдельный цифровой журнал с двумя чек-листами', 'События, задачи обслуживания и сроки документов', 'Готовность основана на зафиксированных фактах']} />
        <LandingCard kicker="03" title="Готовить работу команды" items={['Операционная сводка по ручным записям', 'Разделение ручного учёта и технических журналов', 'Готовность к разным правам доступа и правилам хранения']} />
      </section>
