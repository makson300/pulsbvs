...
1. Получить обезличенные реальные журналы Avata 2, Avata 360 или Mini 4 Pro и описать происхождение, версию ПО, единицы и доступные поля.
...
**Минимальный полезный инкремент завершён: API contracts + backend ADR + инструкция по получению журналов текущего парка.**

Рекомендуемый порядок:

1. Получить разрешённый обезличенный реальный журнал Avata 2, Avata 360 или Mini 4 Pro по [инструкции](docs/ИНСТРУКЦИЯ_ПО_ПОЛУЧЕНИЮ_ЖУРНАЛОВ_DJI.md).
